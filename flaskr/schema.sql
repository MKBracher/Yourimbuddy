...
('10', '5', 'Your First Semester Roadmap', '1. Set yourself up for your studies with our guide for new students. Find out what you need to know, from planning your course to logging into University systems. 2. Check out our libraries. Our expert librarians can assist you with all aspects of research and learning. 3. Book a workshop. Newcastle University''s NUPrep offers FREE academic preparation and support for all University of Newcastle Students in the weeks leading up to each semester. Our courses will introduce you to learning content and completing assessment items in a similar format to your Undergraduate or Enabling Pathways program. 4. Seminars on a range of skills, including academic writing, how to research and plan an essay, and how to take better notes in class. 5. Get active with Newcastle Uni Sports & the Gym. You don’t need to splurge on a gym membership to get moving. Our gym facilities are free to use for University students or you can select to join in on our group sports!'),
